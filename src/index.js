...
function Menu() {
  ...
  return (
    <main className='menu'>
      ...
      { numPizza > 0 ? (
        <>
          <p>Cozinha Italiana autêntica. 6 pratos criativos para escolher. Feito no nosso forno de pedra, tudo orgânico, tudo delicioso.</p>
...
function Button() {
  return <button className='btn'>Fazer Pedido</button>
}
